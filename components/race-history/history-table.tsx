...
import { HistoryData } from '@/data/static/race-history-data';
...
const COLUMNS = [
  ...
  */
  ...
  {
    Header: () => <div className="ltr:ml-auto rtl:mr-auto">Entry</div>,
    accessor: 'entry',
    // @ts-ignore
    Cell: ({ cell: { value } }) => (
  ...
  {
    Header: () => <div className="ltr:ml-auto rtl:mr-auto">Prize</div>,
    accessor: 'amount',
    // @ts-ignore
    Cell: ({ cell: { value } }) => (
      <div className="-tracking-[1px] ltr:text-right rtl:text-left">
        <strong className="mb-0.5 flex justify-end text-base md:mb-1.5 md:text-lg lg:text-base 3xl:text-2xl">
          {Number(value.balance).toFixed(0)}
          <span className="inline-block text-[#2b57a2] ltr:ml-1.5 rtl:mr-1.5 md:ltr:ml-2 md:rtl:mr-2"></span>
        </strong>
        {/*
  ...
  {
    Header: () => <div className="ltr:ml-auto rtl:mr-auto">Reward</div>,
    accessor: 'reward',
    // @ts-ignore
    Cell: ({ cell: { value } }) => (
      <div className="-tracking-[1px] ltr:text-right rtl:text-left">
